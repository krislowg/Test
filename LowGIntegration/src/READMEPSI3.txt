Make a class in a separate file with private fields, public getters and setters, a constructor with and without parameters: Student class
Overload a method: Student class
Describe inheritance and its benefits: At the bottom of the main Integration.java
...
Search a two-dimensional array and identify the coordinates where a value was found: Case 9. Pays. Two dimensional array.
Effectively utilize exception handling for user input of an int. Case 10. Divise.