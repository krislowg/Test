...
public class Integration {
  ...
  public static void main(String[] args) {
    ...
    if (option == 1) {
      ...
      System.out
          .println("Comment dit-on " + numPractice + " en Fran\u00E7ais?"); // Escape sentence
                                                                            // c cedille
      scan.nextLine();
      getNumber = scan.nextLine();
      // compareTo method, compares to strings to see if they are equal. If they are equal returnns
      // the value 0
      ...
      System.out.println(NUMDECIMAL
          + "en Fran\u00E7ais c\'est dix- huit et cinquante-trois. Vrai ou Faux?");
      answer = scan.nextLine();
      answUp = answer.toUpperCase(); // toUpperCase() method converts al the letters of a string to
                                     // Upper Case
      ...
      if (greeting.length() == numLetters) { // String length() method to know the number of letters
                                             // on the greeting string
