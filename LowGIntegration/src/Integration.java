...
public class Integration {
  ...
  public static void main(String[] args) {
    ...
    while (keepLearning) {
      ...
      case 1:
        ...
        answUp = answer.toUpperCase();// toUpperCase() method converts all the
                                      // letters of a
        ...
        if (greeting.length() == numLetters) { // String length() method to know
                                               // the number of
  ...
  public static void displayCounter(String[] counter) {// header: the top line
                                                       // of a method
  ...
  public static int findMin(int[] numArray) {// find the smallest value in an
                                             // array
  ...
  public static int findIndex(int[] numArray, int number) { // Identify the
                                                            // index of a value
    int index = 0;
