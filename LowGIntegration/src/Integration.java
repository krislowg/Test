...
public class Integration {
  ...
  public static void main(String[] args) {
    ...
    String[] counterArray =
        {"zero", "un", "deux", "trois", "quatre", "cinq", "six", "sept", "huit",
            "neuf", "dix", "onze", "doze", "treize", "quatorze"};
    String nextCount;
    ...
    Student stud1 = new Student("Kristy", 2, "Sophmore", "Venezuela");
    ...
    while (keepLearning) {
      ...
      switch (option) { //Switch statement
        case 1:
          ...
          // toUpperCase() method converts all the letters of a string to Upper Case
          ...
          // String length() method to know the number of letters on the greeting string
        ...
        case 2:
          ...
          while (num1 >= 0 && num1 <= 100) { // while loop
            ...
            operationSqrt(num1);
            System.out.println("Enter a different number (1-100) to continue or other to exit this"
                    + "section");
            num1 = scan.nextInt();
          }
          System.out
              .println("You have decided to exit the \"Opereations section\"");
          break;
        ...
        case 6:
          ...
          System.out
              .println("The smallest number of the array is: " + arrayMin);
        ...
        case 9:
          System.out
              .println("Countries and their respective article in French!");
  ...
  /*
   * Operator precedence: All binary operators except for the assignment operators are evaluated 
   * from left to right; assignment operators are evaluated right to left. Postfix unary, 
   * multiplicative, additive, shift, relational, equality, bitwise AND, bitwise exclusive OR, 
   * bitwise inclusive OR, logical AND, logical OR, ternary, and assignment.
   */
   ...
   * parent object. Benefits: - It Allows the code to be reused as many times as needed. - The base
   * class once defined and once it is compiled, it need not be reworked. - Saves time and effort as
